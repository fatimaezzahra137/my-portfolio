      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <div className="mt-10 pt-8 border-t border-gray-200">
                ...
                <div className="flex gap-4">
                  ...
                  >
                    <div className="p-3 bg-gray-100 rounded-lg hover:bg-gray-900 transition-all duration-300 mb-1 group-hover:shadow-lg hover:shadow-gray-400">
                    ...
                    <span className="text-xs font-medium text-gray-600 group-hover:text-gray-900">GitHub</span>
                  </a>
                  ...
                  >
                    <div className="p-3 bg-gray-100 rounded-lg hover:bg-blue-600 transition-all duration-300 mb-1 group-hover:shadow-lg hover:shadow-blue-200">
                      <svg className="w-5 h-5 text-gray-700 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  >
                    <div className="p-3 bg-gray-100 rounded-lg hover:bg-pink-600 transition-all duration-300 mb-1 group-hover:shadow-lg hover:shadow-pink-200">
                      <svg className="w-5 h-5 text-gray-700 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-8 bg-gradient-to-r from-red-50 to-gray-50 rounded-2xl p-6 border border-red-100">
